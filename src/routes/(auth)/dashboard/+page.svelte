<script>
  ...
  var options = {
    ...
    chart: {
        ...
        type: 'bar',
        events: {
      click: function(/** @type {any} */ event, /** @type {any} */ chartContext, /** @type {{ config: { series: { [x: string]: { data: { [x: string]: any; }; }; }; xaxis: { categories: { [x: string]: any; }; }; }; seriesIndex: string | number; dataPointIndex: string | number; }} */ config) {
